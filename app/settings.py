...
class Settings(BaseSettings):
    ...
    companion_prompt_version: Literal["companion-v5"] = "companion-v5"
    ...
    def _upgrade_legacy_prompt_version(cls, value: object) -> object:
        """Keep existing server env files bootable while reporting the active v5 prompt."""

        return "companion-v5" if value == "companion-v4" else value
